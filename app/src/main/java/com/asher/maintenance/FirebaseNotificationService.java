...
import com.asher.maintenance.view.MainActivity;
...
public class FirebaseNotificationService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Log.wtf("notification","received "+remoteMessage);
    ...
    private void sendNotification(String notificationTitle, String notificationBody) {
        ...
        if (!isAppInForeground(this, getPackageName()))
            notificationManager.notify(NotificationUtils.NOTIFICATION_ID_PROGRESS, notificationBuilder.build());
    */
        NotificationUtils.showReminder(this, notificationTitle, notificationBody);
    }
