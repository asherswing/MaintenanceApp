...
public class FormItemFirebase {
    ...
    public FormItemFirebase(String item, HashMap<String,String> answers, boolean allowsNotes, boolean allowsSignature, int formId) {
        this.item = item;
